...
begin
     ...
     randseed:=953926607;    {wilkins hard; kingvalue=100}
     randseed:=1142449284; {Wilkins hard seems nice}
     //randomize;
...
{      new (newcanvas);
     ...
     begin
          ...
          begin
               ...
               begin
                    {Display piece here;}
                    form1.Memo1.lines.add(Piece1.Fullname+' has '+piece1.numroles+' roles:');
