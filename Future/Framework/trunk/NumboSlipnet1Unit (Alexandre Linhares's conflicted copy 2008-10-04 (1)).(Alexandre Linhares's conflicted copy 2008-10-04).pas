...
type     KernelSlipnet = class
                         ...
                         Procedure LinkNodes (NOrigin, NDest: KernelNode; drag: real); virtual;
...
Procedure KernelSlipnet.LinkNodes (NOrigin, NDest: KernelNode; drag: real);
Var Link: KernelLink;
begin
     Link:= KernelLink.create (NOrigin, NDest, drag);
     Links.Add(Link);
end;
...
begin
    ...
    begin
        ...
        begin
            LinkNodes(OriginNode,ReceivedNode, NormalDragConstant);
        end;
    end;
end;
...
begin
    ...
    begin
        ...
        begin
            ...
            LinkNodes(ReceivedNode, OriginNode, NormalDragConstant);
        end;
        i:=i+1;
    end;
    i:=x-1;
