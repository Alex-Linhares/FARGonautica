...
begin
 ...
 //FCCA 8    OOOOHHHH Order of creation in the slipnet put 11 and 110 close!!!
 //BUG bricks[1] := 2; bricks[2] := 5; bricks[3] := 1; bricks[4] := 25;  bricks[5] := 23;  target := 11;

 //FCCA 7    goes in loop...  neurons should solve it.
 //BUG bricks[1] := 3; bricks[2] := 3; bricks[3] := 17; bricks[4] := 11;  bricks[5] := 22;  target := 6;
