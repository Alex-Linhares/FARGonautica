...
Function GetNeededItems (ReceivedConnotation:TConnotation):TList;
var x: integer; L:TList; C:TConnotation;
begin
    L:=TList.Create;
    L:=ReceivedConnotation.GetBasicElements(L);
    Result:=L;
end;
...
begin
    ...
    NeededItems:=GetNeededItems (ReceivedConnotation);
            ...
            begin
                ...
                if C2.InheritsFrom(TNumberInteger) then
                  ...
                  begin
                      ...
                      AvailableSTMItems.Remove(c2);  j:=j-1;
                  end;
                  j:=j+1;
            end;
        end;
...
begin
    ...
    begin
        ...
        begin
            ...
            PrintConnotations(GetNeededItems(C));
