		  ...
		  (let
		    ...
		    (set! temp-jolts
			  (condcons
			   ...
			   temp-jolts))
		    (thermostat
		     100 (* 6 (fail-importance sp-type levelname far-end)))
		  ...
		  (let*
		    ...
		    (set! temp-jolts
			  (condcons
			   ...
			   temp-jolts))
		    (thermostat 0 (* 6 (importance sp-type levelname match)))
		    (set! *bridges* (condcons new-bridge *bridges*))))))))))
	...
	(if (null? near-choices)
		...
		(if (null? far-match)
			...
			([new-bridge
		      ...
		      (thermostat
		       (+ 20
			  (* 13.333333 *full-levels*))
		       (* 150 (sp-prob sp-type near-end)))
			...
			([far-level (car far-match)]
			 ...
			 [new-bridge
		      ...
		      (thermostat
		       0 (* 6 (importance sp-type far-level match)))
