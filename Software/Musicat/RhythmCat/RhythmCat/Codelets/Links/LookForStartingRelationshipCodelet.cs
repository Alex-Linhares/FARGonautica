...
namespace RhythmCat {
    ...
    public class LookForStartingRelationshipCodelet : Codelet {
        ...
        public LookForStartingRelationshipCodelet(int urgency, Codelet parent, Coderack coderack, Workspace workspace, Slipnet slipnet)
            : base("Look for Starting Relationship", urgency, parent, coderack, workspace, slipnet) {
        ...
        public override void Run() {
            ...
            float similarity = workspace.ComputeSimilarityStartOnly(ge1, ge2);

            double r = Utilities.rand.NextDouble() * 100;

            if (r < similarity) {
                if (similarity > 99.999)
                    workspace.AddRelationship(new RelationshipStartIdentical(ge1, ge2, similarity));
                else
                    workspace.AddRelationship(new RelationshipStartSimilar(ge1, ge2, similarity));
