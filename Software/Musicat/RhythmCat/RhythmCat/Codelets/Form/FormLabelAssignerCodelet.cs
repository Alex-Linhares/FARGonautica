...
namespace RhythmCat {
	[Codelet("Labeler", CodeletAttribute.CodeletWorkType.Create, 5, true)]
	public class FormLabelAssignerCodelet : Codelet {
		
		//private const float ACTIVATION_INCREASE_FOR_FEATURE = 20;
		private const float DEFAULT_LABEL_STRENGTH = 50;
		...
		public FormLabelAssignerCodelet(int urgency, Codelet parent, Coderack coderack, Workspace workspace, Slipnet slipnet)
